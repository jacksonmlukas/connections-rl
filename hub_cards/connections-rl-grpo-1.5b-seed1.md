...
tags:
  ...
  - negative-results
model-index:
  - name: connections-rl-grpo-1.5b-seed1
    results:
      - task:
...
# connections-rl-grpo-1.5b-seed1 (1.5B)

GRPO (verifiable-reward RL) LoRA adapter for [Qwen/Qwen2.5-1.5B-Instruct](https://huggingface.co/Qwen/Qwen2.5-1.5B-Instruct), warm-started from [connections-rl-sft](https://huggingface.co/jacksonlukas/connections-rl-sft) and trained with **seed 1**.
...
- **This adapter:** [`jacksonlukas/connections-rl-grpo-1.5b-seed1`](https://huggingface.co/jacksonlukas/connections-rl-grpo-1.5b-seed1)
...
model = PeftModel.from_pretrained(base, "jacksonlukas/connections-rl-grpo-1.5b-seed1")
model.eval()
